    ...
    <MobileLayout>
      <ScrollView contentContainerStyle={styles.container}>
        <View style={styles.logoContainer}>
          ...
          Lorem ipsum dolor sit amet, consectetur adipiscing elit. Quisque aliquam efficitur posuere. Vestibulum pretium sapien augue, in porta justo tempor non. Cras nec arcu ut ipsum sodales convallis vel quis orci. Cras aliquet tempor erat et consectetur. Phasellus sed massa cursus turpis mattis placerat. Sed lobortis quam id odio ultrices, vel pulvinar augue laoreet. Aliquam.
          </Text>
        </View>
        ...
        <View style={styles.ceoContainer}>
          <View style={styles.ceoProfile}>
            ...
            Lorem ipsum dolor sit amet, consectetur adipiscing elit. Fusce a elit in orci volutpat venenatis. Quisque imperdiet rhoncus elit.
            </Text>
          </View>
          <View style={styles.ceoProfile}>
            <Image source={{ uri: 'https://via.placeholder.com/100' }} style={styles.ceoImage} />
        ...
        <View style={styles.mapContainer}>
          ...
          <Image source={{ uri: 'https://via.placeholder.com/300x200' }} style={styles.map} />
        </View>

        
        <View style={styles.contactContainer}>
          <Text style={styles.contactTitle}>Contato</Text>
          <TouchableOpacity style={styles.contactButtonWithoutIcon} onPress={() => handlePhonePress('(31) 3372-1686')}>
            <MaterialIcons name="phone" size={24} color="#fff" />
            <Text style={styles.contactText}>(31) 3372-1686</Text>
          </TouchableOpacity>

        <TouchableOpacity style={styles.contactButton} onPress={() => handlePhonePress('(31) 9 9165-0801')}>
            <MaterialIcons name="phone" size={24} color="#fff" />
        ...
        <TouchableOpacity style={styles.contactButton} onPress={() => handlePhonePress('(31) 9 9988-3988')}>
            <MaterialIcons name="phone" size={24} color="#fff" />
        ...
        <TouchableOpacity style={styles.instagramContainer} onPress={() => Linking.openURL('https://instagram.com/barbeariasimplon')}>
